...
namespace gbbs {
  namespace compiled {
    ...
    size_t CliqueCounting(symmetric_unweighted_graph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_uint32_graph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_float_graph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_double_graph&, size_t, long, double, long, bool, bool, bool, long, bool, double);

    size_t CliqueCounting(symmetric_unweighted_cgraph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_uint32_cgraph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_float_cgraph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
    size_t CliqueCounting(symmetric_double_cgraph&, size_t, long, double, long, bool, bool, bool, long, bool, double);
