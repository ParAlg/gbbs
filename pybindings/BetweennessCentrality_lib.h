...
namespace gbbs {
  namespace compiled {
    ...
    sequence<double> BetweennessCentrality(symmetric_unweighted_graph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_uint32_graph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_float_graph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_double_graph&, size_t);

    sequence<double> BetweennessCentrality(symmetric_unweighted_cgraph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_uint32_cgraph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_float_cgraph&, size_t);
    sequence<double> BetweennessCentrality(symmetric_double_cgraph&, size_t);
