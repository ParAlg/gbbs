...
sequence<uint_parent> HAC(symmetric_uint32_graph& G, std::string linkage, bool similarity=true);
sequence<float_parent> HAC(symmetric_float_graph& G, std::string linkage, bool similarity=true);
sequence<double_parent> HAC(symmetric_double_graph& G, std::string linkage, bool similarity=true);

sequence<uint_parent> HAC(symmetric_uint32_cgraph& G, std::string linkage, bool similarity=true);
sequence<float_parent> HAC(symmetric_float_cgraph& G, std::string linkage, bool similarity=true);
sequence<double_parent> HAC(symmetric_double_cgraph& G, std::string linkage, bool similarity=true);
