...
def main():
  ...
  is_dynamic = [True]
  files = ["dblp_deletion_edges", "wiki_deletion_edges", "stackoverflow_deletion_edges",
          "ctr_deletion_edges", "usa_deletion_edges", "brain_deletion_edges"] #["youtube_deletion_edges","orkut_deletion_edges"]
  init_files = ["wiki_insertion_edges", "stackoverflow_insertion_edges",
          "ctr_insertion_edges", "usa_insertion_edges", "brain_insertion_edges"] #["youtube_insertion_edges", "orkut_insertion_edges"]#["livejournal_insertion_edges", "orkut_insertion_edges"]#["dblp_insertion_edges", "livejournal_insertion_edges"]
  pres = ["wiki", "stackoverflow", "ctr", "usa", "brain"]
  empty = "empty_h"
  stats = ""
  epss = [0.4] #0.8, 1.6, 3.2, 6.4]
  ...
  write_dir = "/home/qliu19/new-exp-4-opt-delete-dedup/"
