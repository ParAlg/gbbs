...
def main():
  ...
  is_dynamic = [True]
  files = ["stackoverflow_insertion_edges", "wiki_insertion_edges", "ctr_insertion_edges", "usa_insertion_edges"] #["orkut_edges", "twitter_edges"]
  pres = ["stackoverflow", "wiki", "ctr", "usa"] #["orkut-single-thread", "twitter-single-thread"]
  empty = "empty_h"
  stats = ""
