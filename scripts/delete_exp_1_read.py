...
def main():
  ...
  write_dir = "/home/qliu19/exp-1-opt-delete/"
  ...
  for p_idx, p in enumerate(program_pres):
    for b_idx, b in enumerate(batch_sizes):
        for eps in e:
            for delta in d:
                read_filename = write_dir + "plds_" + str(p) + "_" + str(eps) + "_" + str(delta) + "_" + str(b) + "_60.out"
                ...
                with open(read_filename, "r") as read_file:
                    ...
                    for line in read_file:
                        ...
                        if "------------" in line and cur_max > 0:
                            ...
                            if split[0].startswith("### Deletion"):
                ...
                print(str(eps), end = ",")
                print(str(delta), end = ",")
                print(str(best_approx_avg), end = ",")
                print(str(best_approx_max), end = ",")
