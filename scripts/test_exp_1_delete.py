...
def main():
  ...
  is_dynamic = [True]
  files = ["wiki_deletion_edges"] #"stackoverflow_deletion_edges", "ctr_deletion_edges", "usa_deletion_edges"] #["youtube_deletion_edges","orkut_deletion_edges"]
  init_files = ["wiki_insertion_edges"] # "stackoverflow_insertion_edges", "ctr_insertion_edges", "usa_insertion_edges"] #["youtube_insertion_edges", "orkut_insertion_edges"]#["livejournal_insertion_edges", "orkut_insertion_edges"]#["dblp_insertion_edges", "livejournal_insertion_edges"]
  pres = ["wiki", "stackoverflow", "ctr", "usa"]
  empty = "empty_h"
  stats = "-stats"
  epss = [0.2, 0.4, 0.8, 1.6, 3.2, 6.4]
  deltas = [3, 6, 12, 24, 48, 96]
  batch_sizes = [100000]#, 1000, 10000, 100000, 1000000, 10000000]
  num_workers = [60]#[1, 2, 4, 8, 16, 30, 60]
  read_dir = "/home/qliu19/dynamic_graph/"
  write_dir = "/home/qliu19/exp-1-regular-delete/"
