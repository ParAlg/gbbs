...
#"/ssd0/graphs/edge_streams_coo/barabasialbert_10_1073741824.coo"
graphs=( "/ssd0/graphs/edge_streams_coo/rmat_268435456")

update_pcts=(1)
insert_to_queries=(1)
batch_sizes=(1000000000000) #10000 100000 1000000 10000000 100000000 1000000000)

binaries=("jayanti.no_starting" "liutarjan.no_starting" "shiloachvishkin.no_starting" "unite.no_starting" "unite_early.no_starting" "unite_nd.no_starting" "unite_rem_cas.no_starting" "unite_rem_lock.no_starting" )
