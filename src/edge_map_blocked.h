...
//list_allocator<em_data_block> data_block_allocator;
...
void alloc_init(G& GA) {
  ...
  // size_t list_alloc_max_blocks = 4*list_alloc_init_blocks;
  cout << "list_alloc init_blocks: " << list_alloc_init_blocks << endl;
  //cout << "list_alloc max_blocks: " << list_alloc_max_blocks << endl;
